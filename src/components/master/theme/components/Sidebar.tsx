...
function Toggler({ defaultExpanded = false, renderToggle, children }: { defaultExpanded?: boolean; children: React.ReactNode; renderToggle: (params: { open: boolean; setOpen: React.Dispatch<React.SetStateAction<boolean>> }) => React.ReactNode }) {
        ...
        >
          ...
          <ListItem>
            <ListItemButton>
              ...
              <ListItemContent>
                <Typography level="title-sm">Triagem</Typography>
              </ListItemContent>
            </ListItemButton>
          </ListItem>
          ...
          <ListItem nested>
            <Toggler
              renderToggle={({ open, setOpen }) => (
                <ListItemButton onClick={() => setOpen(!open)}>
                  <GroupRoundedIcon />
                  <ListItemContent>
                    <Typography level="title-sm">Acolhimento</Typography>
                  </ListItemContent>
            ...
            >
              <List sx={{ gap: 0.5 }}>
                <ListItem sx={{ mt: 0.5 }}>
                  <ListItemButton> <a href="/acolhimento/cadastramento">
                      Cadastramento
                    </a></ListItemButton>
                </ListItem>
                <ListItem>
                  <ListItemButton> <a href="/acolhimento/cupons">
                      Cupons
                    </a></ListItemButton>
                </ListItem>
                <ListItem>
                  <ListItemButton>
                    <a href="/acolhimento/parceiros">
                      Parceiros
                    </a>
                  </ListItemButton>
                </ListItem>
